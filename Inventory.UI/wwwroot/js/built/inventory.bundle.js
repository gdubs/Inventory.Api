...
var NewProduct = function (_React$Component) {
    ...
    function NewProduct() {
        ...
        var _this = _possibleConstructorReturn(this, (NewProduct.__proto__ || Object.getPrototypeOf(NewProduct)).call(this));
    ...
    _createClass(NewProduct, [{
        ...
        value: function render() {
            ...
            var label = this.props.currentProduct.edit ? "Edit Product" : "New product";
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        { className: "pull-right", onClick: function onClick() {
                                return _this2.props.toggleProductHandler();
                            } },
                ...
                React.createElement(
                    "div",
                    { className: "panel-body form-horizontal payment-form" },
                    React.createElement(
                        "div",
                        ...
                        React.createElement(
                            "div",
                            { className: "col-sm-9" },
                            React.createElement("input", { type: "text", value: this.state.name, name: "name", className: "form-control", onChange: this.handleChange })
                        )
                    ),
                    React.createElement(
                        "div",
                        ...
                        React.createElement(
                            "label",
                            { htmlFor: "asin", className: "col-sm-3 control-label" },
                            "ASIN"
                        ),
                        React.createElement(
                            "div",
                            { className: "col-sm-9" },
                            React.createElement("input", { type: "text", value: this.state.asin, name: "asin", className: "form-control", onChange: this.handleChange })
                        )
                    ),
                    React.createElement(
                        "div",
                        ...
                        React.createElement(
                            "label",
                            { htmlFor: "shelfCode", className: "col-sm-3 control-label" },
                            "Shelf Code"
                        ),
                        React.createElement(
                            "div",
                            { className: "col-sm-9" },
                            React.createElement("input", { type: "text", value: this.state.shelfCode, name: "shelfCode", className: "form-control", onChange: this.handleChange })
                        )
                    ),
                    React.createElement(
                        "div",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "button",
                                { type: "button", className: "btn btn-default preview-add-button", onClick: function onClick() {
                                        return _this2.props.saveProductHandler(_this2.state);
                                    } },
...
var _inventoryStore = __webpack_require__(84);
...
ReactDOM.render(React.createElement(
  ...
  { store: _inventoryStore2.default },
  React.createElement(_Products2.default, null)
), document.getElementById('app.inventory')); //import 'babel-polyfill';
...
var _NewProduct = __webpack_require__(15);

var _NewProduct2 = _interopRequireDefault(_NewProduct);

var _reactRedux = __webpack_require__(16);

var _productActions = __webpack_require__(81);
...
var Products = function (_React$Component) {
    ...
    function Products() {
        ...
        _this.openNewObject = _this.openNewObject.bind(_this);
        _this.toggleProductEdit = _this.toggleProductEdit.bind(_this);
        _this.toggleTransactionsView = _this.toggleTransactionsView.bind(_this);
        return _this;
    }
    ...
    _createClass(Products, [{
        ...
        key: 'openNewObject',
        value: function openNewObject(e) {
        ...
        key: 'toggleProductEdit',
        value: function toggleProductEdit(e) {
            this.props.dispatch(productActions.editProductToggleForm(e));
        }
    }, {
        key: 'toggleTransactionsView',
        value: function toggleTransactionsView(e) {
        ...
        value: function render() {
            ...
            for (var p = 0; p < data.length; p++) {
                var currProduct = Object.assign({}, data[p], { index: p });
                products.push(React.createElement(
                    'li',
                    { key: p, className: 'list-group-item' },
                    React.createElement(_Product2.default, { key: p, id: p,
                        product: currProduct,
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'button',
                            { className: 'btn btn-default', onClick: this.openNewObject },
                    ...
                    React.createElement(
                        'div',
                        { className: 'col-md-11' },
                        this.props.products.createNew ? React.createElement(_NewProduct2.default, { saveProductHandler: this.saveProduct, currentProduct: this.props.products.currentProduct }) : null
                    )
                )
            );
        }
...
var _ProductTransactions = __webpack_require__(93);

var _ProductTransactions2 = _interopRequireDefault(_ProductTransactions);
...
var Product = function (_React$Component) {
    ...
    _createClass(Product, [{
        ...
        value: function toggleEdit(e) {
            ...
            var clone = this.state.edit;
            this.setState({ edit: !clone }, function () {
                _this2.props.toggleProductHandler(_this2.state);
            });
        }
    }, {
        key: 'saveEdit',
        ...
        value: function componentWillReceiveProps(nextProps, d) {
        ...
        value: function render() {
            ...
            return React.createElement(
                'div',
                { style: productStyle },
                product.edit ? React.createElement(
                    'div',
                    { className: 'row' },
                    React.createElement(_NewProduct2.default, {
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'div',
                                { className: 'col-sm-9', name: 'shelfCode' },
                                product.shelfCode
                            )
                        )
                    ),
                    React.createElement(
                        ...
                        React.createElement(
                            'label',
                            { htmlFor: 'totalCount', className: 'col-sm-3 control-label' },
                            'Total Available'
                        ),
                        React.createElement(
                            'div',
                            { className: 'col-sm-2', name: 'totalCount' },
                            product.totalCount
                        )
                    ),
                    React.createElement(
                        ...
                        React.createElement(
                            'button',
                            { type: 'button', className: 'btn btn-default', onClick: this.toggleEdit },
                        ...
                        React.createElement(
                            ...
                            { type: 'button', className: 'btn btn-default', onClick: function onClick() {
                                    return _this3.props.toggleTransactionsHandler(_this3.state);
                                } },
                            'Transactions / History'
                        )
                    ),
                    product.expandTransactions ? React.createElement(_ProductTransactions2.default, {
                        transactions: transactions,
                        toggleTransactionsHandler: function toggleTransactionsHandler() {
                            return _this3.props.toggleTransactionsHandler(_this3.state);
                        } }) : null
                )
            );
...
exports.editProductToggleForm = editProductToggleForm;
exports.productTransactionsToggleForm = productTransactionsToggleForm;
exports.saveProduct = saveProduct;
exports.saveNewProduct = saveNewProduct;

var _productProvider = __webpack_require__(82);

var _productProvider2 = _interopRequireDefault(_productProvider);

var _productActionsConstants = __webpack_require__(92);

var constants = _interopRequireWildcard(_productActionsConstants);
...
function getAll() {
    return function (dispatch) {
        _productProvider2.default.getAll().then(function (data) {
...
function editProduct(product) {
    return {
        ...
        payload: _extends({}, product, { edit: true })
    };
}
function editProductToggleForm(product) {
    return {
        type: constants.PRODUCTS_EDIT_EXISTING,
        payload: _extends({}, product)
    };
}
function productTransactionsToggleForm(product) {
    ...
    return function (dispatch) {
        if (!willExpand) {
            dispatch({
                ...
                payload: _extends({}, product, { transactions: [] })
            });
        } else {
            _productProvider2.default.getAllTransactionsByProduct(product.id).then(function (data) {
                dispatch({
                    type: constants.PRODUCTS_TRANSACTIONS_TOGGLE,
                    payload: _extends({}, product, { transactions: data.values })
                });
            }).catch(function (error) {
                dispatch({
...
var _delay = __webpack_require__(83);
...
var products = [{ url: 'yoyoyo', id: 1, name: 'Coke', asin: 'EDIKDO', shelfCode: 'AKDIDO' }, { url: 'yoyoyo', id: 2, name: 'Sprite', asin: 'BLAKDO', shelfCode: 'AKDIDO' }, { url: 'yoyoyo', id: 3, name: 'Pickles', asin: 'TAEKDO', shelfCode: 'DREO90' }, { url: 'yoyoyo', id: 4, name: 'Steak', asin: 'EPALKAO', shelfCode: 'IDIEO8' }];

var transactionHistory = [{ id: 1, type: 'add', productId: 1, count: 50, date: '01/01/2017' }, { id: 2, type: 'add', productId: 1, count: 50, date: '02/01/2017' }, { id: 3, type: 'add', productId: 1, count: 50, date: '03/01/2017' }, { id: 4, type: 'add', productId: 1, count: 50, date: '04/01/2017' }, { id: 5, type: 'sold', productId: 1, count: 35, date: '01/15/2017' }, { id: 6, type: 'sold', productId: 1, count: 60, date: '03/21/2017' }, { id: 7, type: 'sold', productId: 1, count: 5, date: '04/5/2017' }, { id: 8, type: 'add', productId: 2, count: 30, date: '01/01/2017' }, { id: 9, type: 'sold', productId: 2, count: 20, date: '02/01/2017' }, { id: 10, type: 'add', productId: 2, count: 10, date: '03/01/2017' }, { id: 11, type: 'sold', productId: 2, count: 12, date: '04/01/2017' }, { id: 12, type: 'discard', productId: 2, count: 8, date: '04/15/2017' }, { id: 13, type: 'add', productId: 2, count: 60, date: '04/01/2017' }, { id: 14, type: 'sold', productId: 2, count: 5, date: '04/25/2017' }, { id: 15, type: 'add', productId: 3, count: 20, date: '01/01/2017' }, { id: 16, type: 'add', productId: 3, count: 60, date: '02/01/2017' }, { id: 17, type: 'sold', productId: 3, count: 35, date: '02/21/2017' }, { id: 18, type: 'sold', productId: 3, count: 45, date: '03/21/2017' }, { id: 19, type: 'add', productId: 3, count: 50, date: '03/01/2017' }, { id: 20, type: 'discard', productId: 3, count: 10, date: '04/26/2017' }, { id: 21, type: 'sold', productId: 3, count: 15, date: '05/04/2017' }, { id: 15, type: 'add', productId: 4, count: 10, date: '01/01/2017' }, { id: 16, type: 'add', productId: 4, count: 10, date: '02/01/2017' }, { id: 17, type: 'sold', productId: 4, count: 5, date: '01/21/2017' }, { id: 18, type: 'sold', productId: 4, count: 8, date: '02/21/2017' }, { id: 19, type: 'add', productId: 4, count: 10, date: '03/01/2017' }, { id: 20, type: 'discard', productId: 4, count: 7, date: '02/25/2017' }, { id: 21, type: 'sold', productId: 4, count: 6, date: '03/27/2017' }];

var productsProvider = function () {
    function productsProvider() {
        _classCallCheck(this, productsProvider);
    }

    _createClass(productsProvider, null, [{
        key: 'getAll',
        value: function getAll() {
            return new Promise(function (resolve, reject) {
                ...
                data.values.map(function (product) {
                    var count = 0;
                    var transactions = transactionHistory.map(function (transaction) {
        ...
        key: 'getAllTransactionsByProduct',
        value: function getAllTransactionsByProduct(id) {
            return new Promise(function (resolve, reject) {
                var data = {
                    values: [],
                    links: []
...
var _productsReducer = __webpack_require__(86);

var _productsReducer2 = _interopRequireDefault(_productsReducer);

var _shelvesReducer = __webpack_require__(87);

var _shelvesReducer2 = _interopRequireDefault(_shelvesReducer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var reducers = (0, _redux.combineReducers)({
    products: _productsReducer2.default,
    shelves: _shelvesReducer2.default
});
...
function reducer() {
    ...
    switch (action.type) {
        ...
        case constants.PRODUCTS_GET_FULFILLED:
            {
                return _extends({}, state, { products: action.payload, fetching: false, fetched: true });
            }
        case constants.PRODUCTS_CREATE_NEW:
            {
                return _extends({}, state, { createNew: true, currentProduct: action.payload });
            }
        case constants.PRODUCTS_EDIT_TOGGLE:
            {
                var s = _extends({}, state, { products: state.products.map(function (product, i) {
        ...
        case constants.PRODUCTS_TRANSACTIONS_TOGGLE:
            {
                var _s = _extends({}, state, { products: state.products.map(function (product, i) {
                        if (action.payload.index !== i) {
                            return product;
                        }
        ...
        case constants.PRODUCTS_SAVE_NEW_FULFILLED:
            {
                return _extends({}, state, { products: [].concat(_toConsumableArray(state.products), [Object.assign({}, action.payload)]), createNew: false });
            }
        case constants.PRODUCTS_SAVE_UPDATE_FULFILLED:
            {

                var _s2 = _extends({}, state, {
...
var PRODUCTS_GET_ALL = exports.PRODUCTS_GET_ALL = 'PRODUCTS_GET_ALL';
var PRODUCTS_GET_REJECTED = exports.PRODUCTS_GET_REJECTED = 'PRODUCTS_GET_REJECTED';
var PRODUCTS_GET_FULFILLED = exports.PRODUCTS_GET_FULFILLED = 'PRODUCTS_GET_FULFILLED';
var PRODUCTS_CREATE_NEW = exports.PRODUCTS_CREATE_NEW = 'PRODUCTS_CREATE_NEW';
var PRODUCTS_EDIT_EXISTING = exports.PRODUCTS_EDIT_EXISTING = 'PRODUCTS_EDIT_EXISTING';
var PRODUCTS_TRANSACTIONS_TOGGLE = exports.PRODUCTS_TRANSACTIONS_TOGGLE = 'PRODUCTS_TRANSACTIONS_TOGGLE';
var PRODUCTS_SAVE_NEW_FULFILLED = exports.PRODUCTS_SAVE_NEW_FULFILLED = 'PRODUCTS_SAVE_NEW_FULFILLED';
var PRODUCTS_SAVE_UPDATE_FULFILLED = exports.PRODUCTS_SAVE_UPDATE_FULFILLED = 'PRODUCTS_SAVE_UPDATE_FULFILLED';
var PRODUCTS_SAVE_REJECTED = exports.PRODUCTS_SAVE_REJECTED = 'PRODUCTS_SAVE_REJECTED';
...
var _ProductTransaction = __webpack_require__(94);

var _ProductTransaction2 = _interopRequireDefault(_ProductTransaction);
...
var ProductTransactions = function (_React$Component) {
    _inherits(ProductTransactions, _React$Component);

    function ProductTransactions() {
        _classCallCheck(this, ProductTransactions);

        var _this = _possibleConstructorReturn(this, (ProductTransactions.__proto__ || Object.getPrototypeOf(ProductTransactions)).call(this));

        _this.state = null;
        return _this;
    }

    _createClass(ProductTransactions, [{
        key: "componentWillMount",
        value: function componentWillMount(nextProps, d) {
        ...
        value: function render() {
            ...
            var element = this.state == null || this.state.length < 1 ? React.createElement(
                "div",
                null,
                "No Transactions Found"
            ) : React.createElement(_ProductTransaction2.default, null);
            return React.createElement(
                "div",
                null,
                element,
                React.createElement(
                    "button",
                    { type: "button", className: "btn btn-default", onClick: function onClick() {
                            return _this2.props.toggleTransactionsHandler();
                        } },
                    "Exit"
                )
            );
...
exports.default = ProductTransactions;
...
var ProductTransaction = function (_React$Component) {
    _inherits(ProductTransaction, _React$Component);

    function ProductTransaction() {
        _classCallCheck(this, ProductTransaction);

        return _possibleConstructorReturn(this, (ProductTransaction.__proto__ || Object.getPrototypeOf(ProductTransaction)).call(this));
    }

    _createClass(ProductTransaction, [{
        key: "render",
        value: function render() {
            return React.createElement(
                "div",
